...
//        filterChainDefinitionMap.put("/user/1", "authc");// 这里为了测试，只限制/user，实际开发中请修改为具体拦截的请求规则
        // anon：它对应的过滤器里面是空的,什么都没做
//        filterChainDefinitionMap.put("/user/detail", "authc,perms[user:edit]");// 这里为了测试，固定写死的值，也可以从数据库或其他配置中读取
...
//        filterFactoryBean.setFilterChainDefinitionMap(filterChainDefinitionMap);
    ...
    public ShiroFilterChainDefinition shiroFilterChainDefinition() {
        ...
        definition.addPathDefinition("/user/detail", "authc,perms[user:edit]");
